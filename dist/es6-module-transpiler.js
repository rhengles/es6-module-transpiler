        ...
        return s.line(function() {
          return s.call('define', function(arg) {
            ...
            return arg(function() {
              ...
              }, _this.options.dontIndentDefineFn);
            });
          }, _this.options.dontIndentDefine);
        });
      });
    };
  ...
  CLI = (function() {
    ...
    CLI.prototype.argParser = function(argv) {
      return optimist(argv).usage('compile-modules usage:\n\n  Using files:\n    compile-modules INPUT --to DIR [--anonymous] [--type TYPE] [--imports PATH:GLOBAL]\n\n  Using stdio:\n    compile-modules --stdio [--coffee] [--type TYPE] [--imports PATH:GLOBAL] (--module-name MOD|--anonymous)').options({
        ...
        indent: {
          "default": '2',
          describe: 'How to indent the output (number of spaces or tab, e.g. "2", "tab")'
        },
        help: {
          "default": false,
          type: 'boolean',
        ...
        return !args.indent || /^(\d|t(|ab))$/i.test(args.indent);
      });
    };
...
"compiler.js": function(module, exports, require){(function() {
  ...
  Compiler = (function() {
    ...
    Compiler.prototype.parse = function() {
      var eol, line, _i, _len, _ref;
      eol = this.options.eol || '\n';
      this.log(eol, 'SPLITTING BY', encodeURIComponent(eol));
      _ref = this.string.split(eol);
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        line = _ref[_i];
        this.parseLine(line);
      }
    ...
    Compiler.prototype.log = function(a, b, c) {
      return null;
    };
